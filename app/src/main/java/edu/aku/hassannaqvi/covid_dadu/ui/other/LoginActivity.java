...
import edu.aku.hassannaqvi.covid_dadu.core.AppInfo;
import edu.aku.hassannaqvi.covid_dadu.core.DatabaseHelper;
import edu.aku.hassannaqvi.covid_dadu.core.MainApp;
import edu.aku.hassannaqvi.covid_dadu.databinding.ActivityLoginBinding;

import static edu.aku.hassannaqvi.covid_dadu.CONSTANTS.MINIMUM_DISTANCE_CHANGE_FOR_UPDATES;
import static edu.aku.hassannaqvi.covid_dadu.CONSTANTS.MINIMUM_TIME_BETWEEN_UPDATES;
import static edu.aku.hassannaqvi.covid_dadu.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_CONTACTS;
import static edu.aku.hassannaqvi.covid_dadu.CONSTANTS.MY_PERMISSIONS_REQUEST_READ_PHONE_STATE;
import static edu.aku.hassannaqvi.covid_dadu.CONSTANTS.TWO_MINUTES;
import static edu.aku.hassannaqvi.covid_dadu.utils.AppUtilsKt.getPermissionsList;
